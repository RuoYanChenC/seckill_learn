...
import com.cc.dao.SuccessKilledMapper;
import com.cc.dao.cache.RedisDao;
...
import com.cc.enums.SeckillStatEnum;
...
//  如果很明确是 @Component   @Service @Dao  @Controller
@Service
...
/*        Seckill seckill = seckillMapper.queryById(seckillId);
    ...
    /**
     * 执行秒杀操作，失败我们就抛出异常
     *  使用注解控制事务方法的优点：  要保证执行事务的执行时间尽可能的短， 不要穿插其他网络操作，
     *  如果还是需要操作，把这些操作剥离到事务到外边，  不是所有的方法都需要事务
     *
